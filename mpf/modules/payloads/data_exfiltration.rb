# =============================================================================
# MPF Payload Module: data_exfiltration
# OWASP: M2 | Severity: CRITICAL
  ...
  module Modules
    module Payloads
      class <built-in method capitalize of str object at 0x7ea5abc43ef0>
        NAME        = "data_exfiltration".freeze
        OWASP       = "M2".freeze
        SEVERITY    = "CRITICAL".freeze
        DESCRIPTION = "Extracts sensitive data from device storage and transmits it to a remote C2 server.".freeze
        REMEDIATION = "Encrypt all stored data. Implement strict egress filtering and certificate pinning.".freeze
        ...
        def stage(options = {})
          log "[*] Staging payload : #data_exfiltration"
