# =============================================================================
# MPF Payload Module: broadcast_spoofer
# OWASP: M1 | Severity: MEDIUM
  ...
  module Modules
    module Payloads
      class <built-in method capitalize of str object at 0x7ea5abc43ef0>
        NAME        = "broadcast_spoofer".freeze
        OWASP       = "M1".freeze
        SEVERITY    = "MEDIUM".freeze
        DESCRIPTION = "Sends spoofed broadcast intents to trigger unintended application behaviour and state changes.".freeze
        REMEDIATION = "Protect broadcast receivers with permissions. Validate intent source before processing.".freeze
        ...
        def stage(options = {})
          log "[*] Staging payload : #broadcast_spoofer"
